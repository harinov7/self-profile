...
export default function Tentang() {
    ...
    return (
        <div id="about" className="bg-main px-[clamp(24px,2vw,36px)] pt-10 pb-20 font-main flex flex-col gap-3 scroll-mt-10">
            ...
            <div className="flex justify-center mt-10">
                <img src={Profile_Picture_02} onClick={() => setImgOpen(true)} width={300} alt="Foto Profil" className="w-[clamp(250px,90vw,350px)] rounded-xl translate-y-3 w-70 h-70 object-cover" />
