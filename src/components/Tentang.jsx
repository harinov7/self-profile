        ...
        <div id="about" className="bg-main px-[clamp(32px,8vw,96px)] pt-10 pb-20 font-main flex flex-col lg:flex-row-reverse lg:justify-between lg:items-center gap-3 scroll-mt-10">
            <div className="flex flex-col gap-1 lg:gap-3">
                <div className="flex flex-col gap-2">
                    <h1 className="text-[clamp(26px,3vw,48px)] font-extrabold"><span className="text-white border-b-2 lg:border-b-4 pb-1 border-text">Tentang</span></h1>
            ...
            <div className="flex justify-center flex-row-reverse mt-[clamp(12px,3vw,24px)]">
                ...
                <div className="relative">
                    <div className="absolute flex items-center bottom-0 left-4 gap-2 text-white text-xs md:text-sm lg:text-lg bg-card rounded-md px-2 py-1">
