...
export default function Hero({
    ...
    return (
        <div id="home" className={`finisher-header relative h-[650px] font-main px-[clamp(32px,8vw,96px)] pt-20 transition-blur duration-500 lg:px-[clamp(96px,10vw,160px)] lg:pt-35`}>
            <FinisherHeader />
