...
export default function CardSkill({
    ...
    return(
        <div className="border-t-2 border-border rounded-b-3xl p-5 w-[clamp(250px,70vw,400px)] 
        flex flex-col gap-[clamp(12px,3vw,20px)] animate-light transition duration-300
